...
def populate_window(frm_main):
    ...
    lbl_gen_prompts = Label(
        frm_main, text="Generate a random prompt from the pile")
    lbl_num_prompts = Label(
        frm_main, text="Number prompts would you like to generate (1-10):")
